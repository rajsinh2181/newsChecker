...
async function loadFacts() {
  const res = await fetch(
    "https://detihkeiptqrffkvpajh.supabase.co/rest/v1/fact",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRldGloa2VpcHRxcmZma3ZwYWpoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg0MjcxNDAsImV4cCI6MjAyNDAwMzE0MH0.Edzt0H-TG0qqLQmrYfMKDCvvvJONq_iTnyzvw5c-Zes",
      },
    }
  );
...
// const allCatogories = CATEGORIES.map((el) => el.name);
